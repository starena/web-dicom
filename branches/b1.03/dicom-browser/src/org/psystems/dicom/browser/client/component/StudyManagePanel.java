...
//		
		...
		dicDoctors.put("Варданян Т.С.", "US");
		dicDoctors.put("Тарасов С.В.", "ES");
		dicDoctors.put("Кобзева М.Н.", "US");
		dicDoctors.put("Агапидис В.С.", "US");
		
		dicDoctors.put("Головачёва Е.А.", "US"); 
...
//		dicLaborants.put("Бабошкина Л.В.", "");
		...
		dicLaborants.put("Сангалова Р.М.", "");
		...
		dicLaborants.put("Леонтьева С.Б.", "");
