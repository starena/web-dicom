 ...
 * <li>prefix - String, The name of the tier field prefix to filter on.  Optional. </li>
 * <li>dist - double, the distance, in miles, from the centerpoint to the box edge on the diagonal(?).  Required</li>
 * </ul>
 * <p/>
