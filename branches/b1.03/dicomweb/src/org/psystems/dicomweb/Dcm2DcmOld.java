...
//            fmiAttrs.putString(SpecificCharacterSet_IR_144, null, "ISO_IR 144");
//            fmiAttrs.putString(SpecificCharacterSet_IR_144, VR.CS, "ISO_IR 144");
//            System.out.println("HAK ISO_IR144");
            
//            fmiAttrs.setSpecificCharacterSet("ISO_IR 100");
            ...
            if (!nofmi) {
                ...
                DicomObject dcmObj = fmi.getDicomObject();
                
//                this.overwriteObject = new BasicDicomObject();
//                this.overwriteObject.putString(Tag.SpecificCharacterSet, VR.CS, "ISO_IR 144");
//                this.overwriteObject.copyTo(dcmObj);
                
//                DicomElement attr;
//				dcmObj.add(attr);
                
//                for (Iterator<DicomElement> it = dcmObj.iterator(Tag.SpecificCharacterSet,Tag.SpecificCharacterSet); it.hasNext();) {
//    				DicomElement element = it.next();
//    				System.out.println("ELT "+element);
//    				
//    				DicomObject attrs = new BasicDicomObject();
//    				attrs.putString(Tag.SpecificCharacterSet, VR.CS, "ISO_IR 144");
//    				attrs.initFileMetaInformation(tsuid);
