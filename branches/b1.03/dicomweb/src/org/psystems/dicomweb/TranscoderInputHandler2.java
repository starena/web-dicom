 ...
 *
 */
public class TranscoderInputHandler2 implements DicomInputHandler
{
    ...
    public TranscoderInputHandler2(DicomOutputStream out)
    {
        this(out, defaultBufferSize);
    }

    public TranscoderInputHandler2(DicomOutputStream out, int size)
    {
        if (size <= 0) {
    ...
    throws IOException
    {
        ...
        System.out.println("TAG = " + tag + " " + TagUtils.toString(tag));
        switch (tag) {
        case Tag.Item:
            transcodeItem(in);
            break;
...
//        	out.writeHeader(tag, vr, vallen);
            ...
            if (tag == Tag.SpecificCharacterSet
                ...
                System.out.println("SpecificCharacterSet = "+val.length + ";"+vallen+";"+vallen1+";"+val1.length);
//           
