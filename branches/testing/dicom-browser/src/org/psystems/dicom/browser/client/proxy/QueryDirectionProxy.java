...
public class QueryDirectionProxy implements Serializable {
	...
	return "QueryDirectionProxy [dateDirection=" + dateDirection + ", dateTimePlannedBegin=" + dateTimePlannedBegin
		+ ", dateTimePlannedEnd=" + dateTimePlannedEnd + ", directionId=" + directionId
		+ ", directionLocation=" + directionLocation + ", doctorDirectCode=" + doctorDirectCode
		+ ", doctorDirectName=" + doctorDirectName + ", doctorPerformedCode=" + doctorPerformedCode
		+ ", doctorPerformedName=" + doctorPerformedName + ", id=" + id + ", manufacturerDevice="
		+ manufacturerDevice + ", patientBirthDate=" + patientBirthDate + ", patientId=" + patientId
		+ ", patientName=" + patientName + ", patientSex=" + patientSex + ", patientShortName="
		+ patientShortName + "]";
    }
