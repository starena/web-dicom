...
public class Study implements Serializable {
    ...
    private Service[] servicesPerformed;// Выполненные услуги (с привязкой к
					// направлению)
	...
	try {
	    ...
	    throw new IllegalArgumentException("Study Date field wrong format: " + ex.getMessage(), ex);
	}
	try {
	    ...
	    throw new IllegalArgumentException("Study View Protocol Date field wrong format: " + ex.getMessage(), ex);
	}
	...
	return "Study [id=" + id + ", patientId=" + patientId + ", patientName=" + patientName + ", patientShortName="
		+ patientShortName + ", patientSex=" + patientSex + ", patientBirthDate=" + patientBirthDate
		+ ", studyId=" + studyId + ", studyInstanceUID=" + studyInstanceUID + ", studyDate=" + studyDate
		+ ", studyDoctor=" + studyDoctor + ", studyOperator=" + studyOperator + ", studyViewprotocolDate="
		+ studyViewprotocolDate + ", studyType=" + studyType + ", studyDescription=" + studyDescription
		+ ", studyModality=" + studyModality + ", studyViewprotocol=" + studyViewprotocol + ", studyResult="
		+ studyResult + ", ManufacturerModelUID=" + ManufacturerModelUID + ", ManufacturerModelName="
		+ ManufacturerModelName + ", studyUrl=" + studyUrl + ", dcmFilesId=" + Arrays.toString(dcmFilesId)
		+ ", dateFormat=" + dateFormat + ", sqlTimestampFormat=" + sqlTimestampFormat
		+ ", studyDateTimeModify=" + studyDateTimeModify + ", studyDateTimeRemoved=" + studyDateTimeRemoved
		+ ", direction=" + direction + ", servicesPerformed=" + Arrays.toString(servicesPerformed) + "]";
    }
