...
CREATE TABLE WEBDICOM.DIRECTION (
	...
	SENDER_LPU VARCHAR(512), -- Направившее ЛПУ
...
CREATE TABLE WEBDICOM.DIRECTION_DIAGNOSIS (
	FID_DIRECTION BIGINT, -- ссылка на направление
	FID_STUDY BIGINT, -- ссылка на исследование
	...
	CONSTRAINT WEBDICOM.FK_DIRECTION_DIAGNOSIS_STUDY FOREIGN KEY (FID_STUDY) REFERENCES WEBDICOM.STUDY (ID)
);
...
CREATE TABLE WEBDICOM.DIRECTION_SERVICE (
	...
	CONSTRAINT WEBDICOM.FK_DIRECTION_SERVICE_STUDY FOREIGN KEY (FID_STUDY) REFERENCES WEBDICOM.STUDY (ID)
);
