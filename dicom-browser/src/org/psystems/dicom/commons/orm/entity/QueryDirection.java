...
public class QueryDirection {
	...
	try {
	    ...
	    if (dateTimePlannedBegin != null
		    && dateTimePlannedEnd != null
		    && ORMUtil.dateTimeSQLToUtilDate(dateTimePlannedBegin).getTime() > ORMUtil.dateTimeSQLToUtilDate(
			    dateTimePlannedEnd).getTime()) {
	...
	return "QueryDirection [id=" + id + ", directionId=" + directionId + ", dateDirection=" + dateDirection
		+ ", ManufacturerDevice=" + ManufacturerDevice + ", dateTimePlannedBegin=" + dateTimePlannedBegin
		+ ", dateTimePlannedEnd=" + dateTimePlannedEnd + ", directionLocation=" + directionLocation
		+ ", doctorDirectName=" + doctorDirectName + ", doctorDirectCode=" + doctorDirectCode
		+ ", doctorPerformedName=" + doctorPerformedName + ", doctorPerformedCode=" + doctorPerformedCode
		+ ", patientId=" + patientId + ", patientName=" + patientName + ", patientSex=" + patientSex
		+ ", patientBirthDate=" + patientBirthDate + ", patientShortName=" + patientShortName + ", senderLPU="
		+ senderLPU + "]";
    }
