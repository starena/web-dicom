 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://webservice.dicom.psystems.org/}direction" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class QueryDirectionResp {
     ...
     * 
     */
    public List<Direction> getReturn() {
        if (_return == null) {
            _return = new ArrayList<Direction>();
        }
        return this._return;
    }
