...
public class DCMQuery {
    ...
    private List<DicomObject> result;
    ...
    public List<DicomObject> getResult() {
		return result;
	}
    ...
    private static InputStream openFileOrURL(String url) throws IOException {
        if (url.startsWith("resource:")) {
            return DCMQuery.class.getClassLoader().getResourceAsStream(
                    url.substring(9));
        }
        try {
